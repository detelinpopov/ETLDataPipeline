    ...
    public class RemoveDuplicatesRuleTests
    {
        ...
        public void RemoveDuplicatesRule_RemovesDuplicates()
        {
            ...
            var transactions = new List<TransactionModel>
            {
                ...
                new() { Id = 1, TransactionDate = new DateTime(2023, 10, 15), Amount = 100.50m, Customer = new CustomerModel {Id = 2,  Name = "Customer 1" } },
                new() { Id = 2, TransactionDate = new DateTime(2023, 10, 16), Amount = 200.75m, Customer = new CustomerModel {Id = 3,  Name = "Customer 2" } }
            };
